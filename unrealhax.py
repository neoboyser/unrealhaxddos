...
TELEGRAM_BOT_TOKEN = '7535140025:AAFSAyY1pRNnvN1TnGAK6VHKq5WTGnZ1nss'
ADMIN_USER_ID = 1321020431
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the ⏤͟͞•𝙄𝙉𝙑𝙀𝘿ᯓ𝘽𝙍𝙔𝙏⛩️☄️ 🔥*\n\n"
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our ⏤͟͞•𝙄𝙉𝙑𝙀𝘿ᯓ𝘽𝙍𝙔𝙏⛩️☄️ service!*", parse_mode='Markdown')
